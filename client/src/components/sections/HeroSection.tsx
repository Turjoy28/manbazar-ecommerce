  ...
  return (
    <section className="relative w-full min-h-105 md:min-h-130 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center pt-14 h-full min-h-105 md:min-h-130 px-4 text-center">
        ...
        <a
          href={targetHref}
          className="bg-primary text-(--primary-text) hover:bg-primary/90 font-semibold px-8 py-3 rounded-sm transition-all duration-200 text-sm md:text-lg cursor-pointer animate-cta-bounce"
        >
          অর্ডার করতে চাই
        </a>
      </div>
