        ...
        <div className="flex gap-2 overflow-x-auto pb-1">
          {displayImages.map((img, idx) => (
            <button
              ...
              className={`relative w-16 h-20 md:w-20 md:h-24 shrink-0 rounded-lg overflow-hidden border-2 transition-all duration-200 ${
                activeIndex === idx
      ...
      <div className="flex gap-2 flex-wrap">
        {list.map((size) => (
          <button
            ...
            className={`w-12 h-12 rounded-lg border-2 font-semibold text-sm transition-all duration-200 ${
              selected === size
